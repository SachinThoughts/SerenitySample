Feature: Verify default handoff
  ...
  @434992 @434993 @Sprint102 @PRCMUser
  Scenario Outline: Verify user is able to add newly added handoff type on R1 Decision screen
    ...
    And user should be able to view Added column value as system current date
    And user should be able to view Created column value as Logged in username and userid: "getDisplayName"
    And user should be able to view Followup column value as system current date
    ...
    And user should be able to view Added column value as system current date in Account Action History
    ...
    And user should be able to view Followup column value as system current date in Account Action History
