...
public class WorkflowConfigurationPage extends PageObject {
	...
	/*@FindBy(xpath="//*[@id='step1']/div[1]/div/div[2]/button")
	private WebElementFacade continueBtnOnHandoffTypeTab;
	
	@FindBy(xpath="//*[@id='step2']/div[1]/div/div[2]/button")
	private WebElementFacade continueBtnOnRecipientTab;
	

	@FindBy(xpath="//*[@id='step3']/div[1]/div/div[2]/button")
	private WebElementFacade continueBtnOnActionTab;
	
	//*[@id='step3']/div[1]/div/div[2]/button;
...
*/	public String getCreatedByFieldValue() {
	...
	public void clickOnHandoffTypeRadioBtn(String handoffName) {
		...
		//listOfRadioLabelOnHandoffTab.get(getPositionOfHandoffType(handoffName)).click();
	}
