...
public class ProfessionalUDCStepDef extends PageObject {
	...
	@When("^user hovers on Settings-R1_Decision$")
	public void user_hovers_on_Settings_R1_Decision() {
		settingsPage.hoverSettingsR1Decisions();
	}

	@When("^clicks on Facility Group Configuration$")
	public void clicks_on_Facility_Group_Configuration() {
		settingsPage.clickFaciltyGroupConfig();
	}
	...
	public void user_clicks_on_UDC_Admin_configuration() {
		settingsPage.clickUDCAdminConfig();
	}
