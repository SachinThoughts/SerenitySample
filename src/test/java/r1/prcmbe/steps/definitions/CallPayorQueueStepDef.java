...
public class CallPayorQueueStepDef {
	...
	public void user_should_be_able_to_view_the_account_added_to_Call_Queue() {
		Assert.assertTrue("User not able to view the account added to Call queue",
				callPayorQueuePage.isCallPayerQueueInvoiceVisible());
	}
	...
	@Then("^user should be able to view the action saved successfully$")
	public void user_should_be_able_to_view_the_action_saved_successfully() {
	}
